...
# plt.savefig('pics/paper/simulated_labeled.pdf', figsize=(9, 8))
...
plt.axhline(x_is['x+'], label='x+', c='blue')
plt.axhline(x_is['x-'], label='x+', c='red')
plt.axhline(x_is['xu'], label='x+', c='black')
...
polyf = np.poly1d(np.polyfit(xs, data['f'], deg=4))
